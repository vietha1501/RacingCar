...
checkpoint_path = "drive/My Drive/dqn-model"
train_episodes = 1500000
save_freq_episodes = train_episodes/10000 ###############333
finished = False
...
saver = tf.train.Saver(max_to_keep=100) #max number of checkpoints = 500
